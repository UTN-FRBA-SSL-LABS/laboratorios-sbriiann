...
> R:Linea 24 lo que hace es acumular el precio de cada producto ignorando su cantidad

**P7** — ¿Qué debería hacer esa línea para calcular el total correctamente?

> R: multiplicar el precio unitario por la cantidad del producto
...
> R: Falla, devuelve 1 y deberia devolver 0
...
> R:Las lineas 29 y 30 no se ejecutaron porque el comando de cobertura midio los tests unitarios 
...
> R:El unitario prueba una funcion aislada, el de integracion un conjunto de funciones, el que lo detecto primero fue el unitario
...
> R:en C no hay verificacion de limites y se pueden romper datos en memoria, en java controla los indices y lanza una excepcion
...
> R:permite verificar el comportamiento de forma automatica, evitando asumir que el codigo funciona a simple vista
...
> R:Porque al multiplicar por 1 da el mismo resultado que no multiplicar
